    ...
    async def send() -> None:
        ...
        with message_container:  # NEW
            ...
            with ui.row().classes("ml-12 gap-1 -mt-4") as feedback_row:
                # Like (palec nahoru)
                with ui.button(on_click=lambda: print("Like clicked")).props("flat dense").classes("p-1"):
                    ui.html("""
                ...
                # Dislike (palec dolů)
                with ui.button(on_click=lambda: print("Dislike clicked")).props("flat dense").classes("p-1"):
                    ui.html("""
